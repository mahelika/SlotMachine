Slot Machine Game 🎰
This project is a fun, interactive slot machine built with HTML, CSS, and JavaScript. It offers a classic slot machine experience with modern styling and features.

Features:
Responsive Design: Adaptable to different screen sizes with a sleek, mobile-friendly interface.
Interactive Gameplay: Spin the reels, place bets.
